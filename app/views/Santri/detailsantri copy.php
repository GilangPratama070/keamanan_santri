...
<div class="main">
    <div class="topbar">
        <div class="welcome">
            <span class="selamatdatang">Selamat Datang di, <?= $data['title']; ?></span>
        </div>
        <div class="toggle">
            ...
            <div class="card" style="box-shadow: 3px 3px 3px rgba(0, 0, 0, 10%);">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered" style="font-size: 1.5rem ;">
                        ...
                        <tbody>
                            <?php $no = 1 ?>
                            <?php foreach ($datadetailsantri['santri'] as $row) : ?>
                            <?php var_dump($row) ?>
                            <?php endforeach; ?>
                            <tr>
                                <td><?= $no ?></td>
                                <td><?= $data['santri']['pelanggaran']; ?></td>
                                <td><?= $data['santri']['tanggal']; ?></td>
                                <td><?= $data['santri']['hukuman']; ?></td>
                                <td><?= $data['santri']['poin']; ?></td>
                                <td>
                ...
                <div class="profilSantriPelanggaran">
                    ...
                    <div class="profilSantri-right-main">
                        ...
                        <div class="profilSantri-right-bottom-main">
                            ...
                            <div class="aksi">
                                <a href="<?= base_url; ?>/santri/edit/<?= $row['id_santri'] ?>" class="badge badgeinfo"
                                    style="font-size: 1.5rem; ">Edit</a>
                                <a href="<?= base_url; ?>/santri/hapus/<?= $row['id_santri'] ?>"
